...
/**
 * The {@link DataChangeEventPayload} Interface should be implemented by any object that represents
 ...
 *
 * {@link DataChangeEventPayload ::getData} is for returning the data payload itself.
 * This object should be serializable to Json by Jackson ObjectMapper
 */
public interface DataChangeEventPayload {
    /**
