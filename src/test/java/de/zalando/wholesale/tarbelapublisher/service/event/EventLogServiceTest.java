...
import de.zalando.wholesale.tarbelapublisher.web.FlowIdComponent;
...
import static de.zalando.wholesale.tarbelapublisher.service.event.EventLogServiceImpl.DEFAULT_LIMIT;
...
public class EventLogServiceTest {
    ...
    public void setUp() throws Exception {
        ...
        eventLog = EventLog.builder().id(rand.nextInt()).eventBodyData(WAREHOUSE_EVENT_BODY_DATA)
    ...
    public void testCreateWarehouseEventLog() throws Exception {
        final EventLog warehouseEventLog = eventLogService.createEventLog(
                EventDataOperation.UPDATE, mockPayload, PUBLISHER_EVENT_TYPE, PUBLISHER_DATA_TYPE, traceId);
        assertThat(warehouseEventLog.getEventBodyData(), is(WAREHOUSE_EVENT_BODY_DATA));
        assertThat(warehouseEventLog.getDataOp(), is(EventDataOperation.UPDATE.toString()));
        assertThat(warehouseEventLog.getEventType(), is(PUBLISHER_EVENT_TYPE));
        assertThat(warehouseEventLog.getDataType(), is(PUBLISHER_DATA_TYPE));
        assertThat(warehouseEventLog.getStatus(), is(EventStatus.NEW.toString()));
        assertThat(warehouseEventLog.getFlowId(), is(traceId));
    }
    ...
    public void testCreateSnapshotEvents() {
        ...
        assertThat(snapshotEventLog.getEventBodyData(), is(WAREHOUSE_EVENT_BODY_DATA));
    }
}
