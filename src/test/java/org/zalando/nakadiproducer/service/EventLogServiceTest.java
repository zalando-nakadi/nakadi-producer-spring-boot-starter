...
import org.zalando.nakadiproducer.api.event.model.BunchOfEventsDTO;
...
import org.zalando.nakadiproducer.api.event.model.BunchOfEventUpdatesDTO;
import org.zalando.nakadiproducer.api.event.model.EventUpdateDTO;
...
import static org.zalando.nakadiproducer.util.Fixture.SINK_ID;
...
public class EventLogServiceTest {
    ...
    public void setUp() throws Exception {
        ...
        when(nakadiProperties.getSinkId()).thenReturn(SINK_ID);
    ...
    public void testSearchEventsWithoutLimit() throws Exception {
        when(eventLogRepository.search(CURSOR, EventStatus.NEW.name(), EventLogServiceImpl.DEFAULT_LIMIT)).thenReturn(events);
    ...
    public void testSearchEventsWithInvalidCursor() throws Exception {
        eventLogService.searchEvents("a1", EventStatus.NEW.toString(), EventLogServiceImpl.DEFAULT_LIMIT);
    }
